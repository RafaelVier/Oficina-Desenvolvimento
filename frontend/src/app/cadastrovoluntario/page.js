    ...
    <div className={styles.containerGeral}>
      ...
      <div className={styles.formContainer}>
        ...
        <form onSubmit={handleSubmit} className={styles.formulario}>
          ...
          <label><b>CPF*</b><br/>
            <input name="cpf" value={form.cpf} onChange={handleChange} required style={{width: "100%", marginBottom: 16, padding: 8, borderRadius: 6, border: "2px solid #2d253c"}} placeholder="111.222.333-44" />
          </label>
